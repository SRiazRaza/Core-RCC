...
namespace Rahmat_Casting_Center
{
    public partial class frmAddEditAccount : Form
    {
        ...
        private void txt_waist_KeyPress(object sender, KeyPressEventArgs e)
        {
            char ch = e.KeyChar;
        ...
        private void txt_labour_KeyPress(object sender, KeyPressEventArgs e)
        {
            char ch = e.KeyChar;
            if (!char.IsDigit(ch) && ch != 8 && ch != 46) { e.Handled = true; }
        ...
        private void txt_gold_KeyPress(object sender, KeyPressEventArgs e)
        {
            char ch = e.KeyChar;
            if (!char.IsDigit(ch) && ch != 8 && ch != 46) { e.Handled = true; }
